...
/* The supply categories BCI buys under, transcribed from procurement's sheet
   (`supliers cat.xlsx`): 22 categories, 170 sub-items. Suppliers tick every one
   that applies, so this is a multi-select, not a dropdown. `key` is what the
   registration records, so renaming one means renaming it in CATEGORIES in
   api/_supplier-registration.js too.

   English and the category-level Arabic are the sheet's own wording. The sheet
   carries no Arabic for the sub-items and no Spanish at all, so those are
   translations rather than client copy — worth a review by someone who knows
   the trade terms. */
const SUPPLIER_CATEGORIES = [
  { key: 'raw-materials', en: 'Raw Materials', ar: 'المواد الخام', es: 'Materias Primas',
    items: [
      ...
      { key: 'epoxy-raw-materials', en: 'Epoxy Raw Materials', ar: 'المواد الخام للإيبوكسي', es: 'Materias Primas para Epoxi' },
      { key: 'polyurea-raw-materials', en: 'Polyurea Raw Materials', ar: 'المواد الخام للبولي يوريا', es: 'Materias Primas para Poliurea' },
      { key: 'acrylic-polymer-emulsions', en: 'Acrylic / Polymer Emulsions', ar: 'مستحلبات الأكريليك / البوليمر', es: 'Emulsiones Acrílicas / Poliméricas' },
      ...
      { key: 'bitumen-bituminous-materials', en: 'Bitumen & Bituminous Materials', ar: 'البيتومين والمواد البيتومينية', es: 'Betún y Materiales Bituminosos' },
      ...
      { key: 'silica-silica-flour', en: 'Silica / Silica Flour', ar: 'السيليكا / مسحوق السيليكا', es: 'Sílice / Harina de Sílice' },
  ...
  { key: 'packaging', en: 'Packaging Materials', ar: 'مواد التعبئة والتغليف', es: 'Materiales de Embalaje',
    items: [
      { key: 'drums', en: 'Drums', ar: 'البراميل', es: 'Tambores' },
      { key: 'ibc-tanks', en: 'IBC Tanks', ar: 'خزانات IBC', es: 'Tanques IBC' },
      { key: 'plastic-pails', en: 'Plastic Pails', ar: 'الدلاء البلاستيكية', es: 'Cubetas de Plástico' },
      { key: 'bags', en: 'Bags', ar: 'الأكياس', es: 'Sacos' },
      { key: 'bottles', en: 'Bottles', ar: 'الزجاجات', es: 'Botellas' },
      { key: 'labels', en: 'Labels', ar: 'الملصقات', es: 'Etiquetas' },
      { key: 'pallets', en: 'Pallets', ar: 'المنصات النقالة', es: 'Palés' },
      { key: 'packaging-accessories', en: 'Packaging Accessories', ar: 'ملحقات التعبئة والتغليف', es: 'Accesorios de Embalaje' },
    ] },
  { key: 'production-consumables', en: 'Production Materials & Consumables', ar: 'مواد ومستهلكات الإنتاج', es: 'Materiales y Consumibles de Producción',
    items: [
      { key: 'production-consumables', en: 'Production Consumables', ar: 'مستهلكات الإنتاج', es: 'Consumibles de Producción' },
      { key: 'additives', en: 'Additives', ar: 'الإضافات', es: 'Aditivos' },
      { key: 'filters', en: 'Filters', ar: 'الفلاتر', es: 'Filtros' },
      { key: 'mixing-consumables', en: 'Mixing Consumables', ar: 'مستهلكات الخلط', es: 'Consumibles de Mezclado' },
      { key: 'spray-equipment-consumables', en: 'Spray Equipment Consumables', ar: 'مستهلكات معدات الرش', es: 'Consumibles de Equipos de Proyección' },
      { key: 'production-tools', en: 'Production Tools', ar: 'أدوات الإنتاج', es: 'Herramientas de Producción' },
      { key: 'other-production-consumables', en: 'Other Production Consumables', ar: 'مستهلكات إنتاج أخرى', es: 'Otros Consumibles de Producción' },
    ] },
  { key: 'insulation', en: 'Insulation Materials', ar: 'مواد العزل الحراري', es: 'Materiales de Aislamiento',
    items: [
      { key: 'pu-foam', en: 'PU Foam', ar: 'رغوة البولي يوريثان', es: 'Espuma de PU' },
      { key: 'pur-pir', en: 'PUR / PIR', ar: 'PUR / PIR', es: 'PUR / PIR' },
      { key: 'xps', en: 'XPS', ar: 'XPS', es: 'XPS' },
      { key: 'eps', en: 'EPS', ar: 'EPS', es: 'EPS' },
      { key: 'thermal-insulation-boards', en: 'Thermal Insulation Boards', ar: 'ألواح العزل الحراري', es: 'Paneles de Aislamiento Térmico' },
      { key: 'insulation-accessories', en: 'Insulation Accessories', ar: 'ملحقات العزل', es: 'Accesorios de Aislamiento' },
    ] },
  { key: 'flooring', en: 'Flooring Materials', ar: 'مواد الأرضيات', es: 'Materiales para Pisos',
    items: [
      { key: 'epoxy-flooring', en: 'Epoxy Flooring', ar: 'أرضيات الإيبوكسي', es: 'Pisos Epóxicos' },
      { key: 'pu-flooring', en: 'PU Flooring', ar: 'أرضيات البولي يوريثان', es: 'Pisos de PU' },
      { key: 'industrial-flooring', en: 'Industrial Flooring', ar: 'الأرضيات الصناعية', es: 'Pisos Industriales' },
      { key: 'decorative-flooring', en: 'Decorative Flooring', ar: 'الأرضيات الديكورية', es: 'Pisos Decorativos' },
      { key: 'flooring-aggregates', en: 'Flooring Aggregates', ar: 'ركام الأرضيات', es: 'Áridos para Pisos' },
      { key: 'flooring-additives', en: 'Flooring Additives', ar: 'إضافات الأرضيات', es: 'Aditivos para Pisos' },
      { key: 'flooring-accessories', en: 'Flooring Accessories', ar: 'ملحقات الأرضيات', es: 'Accesorios para Pisos' },
    ] },
  { key: 'protective-coatings', en: 'Protective & Industrial Coatings', ar: 'الطلاءات الصناعية ومواد الحماية', es: 'Recubrimientos Industriales y de Protección',
    items: [
      { key: 'anti-corrosion-coatings', en: 'Anti-Corrosion Coatings', ar: 'طلاءات مقاومة التآكل', es: 'Recubrimientos Anticorrosivos' },
      { key: 'chemical-resistant-coatings', en: 'Chemical Resistant Coatings', ar: 'طلاءات مقاومة للكيماويات', es: 'Recubrimientos Resistentes a Químicos' },
      { key: 'uv-resistant-coatings', en: 'UV Resistant Coatings', ar: 'طلاءات مقاومة للأشعة فوق البنفسجية', es: 'Recubrimientos Resistentes a UV' },
      { key: 'protective-coatings', en: 'Protective Coatings', ar: 'الطلاءات الواقية', es: 'Recubrimientos Protectores' },
      { key: 'industrial-coatings', en: 'Industrial Coatings', ar: 'الطلاءات الصناعية', es: 'Recubrimientos Industriales' },
      { key: 'coating-additives', en: 'Coating Additives', ar: 'إضافات الطلاءات', es: 'Aditivos para Recubrimientos' },
    ] },
  { key: 'construction-chemicals', en: 'Construction Chemicals & Concrete Repair', ar: 'كيماويات البناء وإصلاح الخرسانة', es: 'Químicos para Construcción y Reparación de Concreto',
    items: [
      { key: 'construction-chemicals', en: 'Construction Chemicals', ar: 'كيماويات البناء', es: 'Químicos para Construcción' },
      { key: 'repair-mortars', en: 'Repair Mortars', ar: 'مونة الإصلاح', es: 'Morteros de Reparación' },
      { key: 'grouts', en: 'Grouts', ar: 'مواد الحقن (الجراوت)', es: 'Morteros de Inyección (Grouts)' },
      { key: 'concrete-repair-materials', en: 'Concrete Repair Materials', ar: 'مواد إصلاح الخرسانة', es: 'Materiales de Reparación de Concreto' },
      { key: 'concrete-additives', en: 'Concrete Additives', ar: 'إضافات الخرسانة', es: 'Aditivos para Concreto' },
      { key: 'surface-preparation-materials', en: 'Surface Preparation Materials', ar: 'مواد تحضير الأسطح', es: 'Materiales de Preparación de Superficies' },
      { key: 'anchoring-materials', en: 'Anchoring Materials', ar: 'مواد التثبيت', es: 'Materiales de Anclaje' },
      { key: 'concrete-protection-materials', en: 'Concrete Protection Materials', ar: 'مواد حماية الخرسانة', es: 'Materiales de Protección de Concreto' },
    ] },
  { key: 'sealants-adhesives', en: 'Sealants & Adhesives', ar: 'مواد السيلانت واللاصق', es: 'Selladores y Adhesivos',
    items: [
      { key: 'construction-sealants', en: 'Construction Sealants', ar: 'سيلانت البناء', es: 'Selladores de Construcción' },
      { key: 'joint-sealants', en: 'Joint Sealants', ar: 'سيلانت الفواصل', es: 'Selladores de Juntas' },
      { key: 'construction-adhesives', en: 'Construction Adhesives', ar: 'لواصق البناء', es: 'Adhesivos de Construcción' },
      { key: 'structural-adhesives', en: 'Structural Adhesives', ar: 'اللواصق الإنشائية', es: 'Adhesivos Estructurales' },
      { key: 'joint-fillers', en: 'Joint Fillers', ar: 'حشوات الفواصل', es: 'Rellenos de Juntas' },
      { key: 'bonding-agents', en: 'Bonding Agents', ar: 'مواد الربط', es: 'Agentes de Adherencia' },
    ] },
  { key: 'machinery-equipment', en: 'Machinery & Equipment', ar: 'الآلات والمعدات', es: 'Maquinaria y Equipos',
    items: [
      { key: 'production-machinery', en: 'Production Machinery', ar: 'آلات الإنتاج', es: 'Maquinaria de Producción' },
      { key: 'mixing-equipment', en: 'Mixing Equipment', ar: 'معدات الخلط', es: 'Equipos de Mezclado' },
      { key: 'reactors', en: 'Reactors', ar: 'المفاعلات', es: 'Reactores' },
      { key: 'filling-machines', en: 'Filling Machines', ar: 'آلات التعبئة', es: 'Máquinas de Llenado' },
      { key: 'packaging-machines', en: 'Packaging Machines', ar: 'آلات التغليف', es: 'Máquinas de Embalaje' },
      { key: 'pumps', en: 'Pumps', ar: 'المضخات', es: 'Bombas' },
      { key: 'compressors', en: 'Compressors', ar: 'الضواغط', es: 'Compresores' },
      { key: 'spray-machines', en: 'Spray Machines', ar: 'آلات الرش', es: 'Máquinas de Proyección' },
      { key: 'industrial-equipment', en: 'Industrial Equipment', ar: 'المعدات الصناعية', es: 'Equipos Industriales' },
      { key: 'other-equipment', en: 'Other Equipment', ar: 'معدات أخرى', es: 'Otros Equipos' },
    ] },
  { key: 'spare-parts', en: 'Spare Parts & Maintenance', ar: 'قطع الغيار والصيانة', es: 'Repuestos y Mantenimiento',
    items: [
      { key: 'mechanical-spare-parts', en: 'Mechanical Spare Parts', ar: 'قطع غيار ميكانيكية', es: 'Repuestos Mecánicos' },
      { key: 'electrical-spare-parts', en: 'Electrical Spare Parts', ar: 'قطع غيار كهربائية', es: 'Repuestos Eléctricos' },
      { key: 'pumps-valves', en: 'Pumps & Valves', ar: 'المضخات والصمامات', es: 'Bombas y Válvulas' },
      { key: 'motors', en: 'Motors', ar: 'المحركات', es: 'Motores' },
      { key: 'bearings', en: 'Bearings', ar: 'المحامل', es: 'Rodamientos' },
      { key: 'filters', en: 'Filters', ar: 'الفلاتر', es: 'Filtros' },
      { key: 'machine-spare-parts', en: 'Machine Spare Parts', ar: 'قطع غيار الآلات', es: 'Repuestos de Maquinaria' },
      { key: 'maintenance-consumables', en: 'Maintenance Consumables', ar: 'مستهلكات الصيانة', es: 'Consumibles de Mantenimiento' },
      { key: 'tools', en: 'Tools', ar: 'الأدوات', es: 'Herramientas' },
    ] },
  { key: 'electrical', en: 'Electrical Materials & Equipment', ar: 'المواد والمعدات الكهربائية', es: 'Materiales y Equipos Eléctricos',
    items: [
      { key: 'cables', en: 'Cables', ar: 'الكابلات', es: 'Cables' },
      { key: 'switches', en: 'Switches', ar: 'المفاتيح الكهربائية', es: 'Interruptores' },
      { key: 'control-panels', en: 'Control Panels', ar: 'لوحات التحكم', es: 'Tableros de Control' },
      { key: 'electrical-components', en: 'Electrical Components', ar: 'المكونات الكهربائية', es: 'Componentes Eléctricos' },
      { key: 'sensors', en: 'Sensors', ar: 'الحساسات', es: 'Sensores' },
      { key: 'plc-automation', en: 'PLC / Automation', ar: 'PLC / الأتمتة', es: 'PLC / Automatización' },
      { key: 'electrical-tools', en: 'Electrical Tools', ar: 'الأدوات الكهربائية', es: 'Herramientas Eléctricas' },
      { key: 'electrical-equipment', en: 'Electrical Equipment', ar: 'المعدات الكهربائية', es: 'Equipos Eléctricos' },
    ] },
  { key: 'mechanical', en: 'Mechanical Materials & Equipment', ar: 'المواد والمعدات الميكانيكية', es: 'Materiales y Equipos Mecánicos',
    items: [
      { key: 'pipes-fittings', en: 'Pipes & Fittings', ar: 'المواسير والوصلات', es: 'Tuberías y Accesorios' },
      { key: 'valves', en: 'Valves', ar: 'الصمامات', es: 'Válvulas' },
      { key: 'pumps', en: 'Pumps', ar: 'المضخات', es: 'Bombas' },
      { key: 'motors', en: 'Motors', ar: 'المحركات', es: 'Motores' },
      { key: 'bearings', en: 'Bearings', ar: 'المحامل', es: 'Rodamientos' },
      { key: 'mechanical-tools', en: 'Mechanical Tools', ar: 'الأدوات الميكانيكية', es: 'Herramientas Mecánicas' },
      { key: 'mechanical-equipment', en: 'Mechanical Equipment', ar: 'المعدات الميكانيكية', es: 'Equipos Mecánicos' },
      { key: 'industrial-components', en: 'Industrial Components', ar: 'المكونات الصناعية', es: 'Componentes Industriales' },
    ] },
  { key: 'laboratory', en: 'Laboratory Equipment & Chemicals', ar: 'معدات ومواد المختبر', es: 'Equipos y Químicos de Laboratorio',
    items: [
      { key: 'laboratory-equipment', en: 'Laboratory Equipment', ar: 'معدات المختبر', es: 'Equipos de Laboratorio' },
      { key: 'testing-equipment', en: 'Testing Equipment', ar: 'معدات الاختبار', es: 'Equipos de Ensayo' },
      { key: 'laboratory-chemicals', en: 'Laboratory Chemicals', ar: 'كيماويات المختبر', es: 'Químicos de Laboratorio' },
      { key: 'laboratory-consumables', en: 'Laboratory Consumables', ar: 'مستهلكات المختبر', es: 'Consumibles de Laboratorio' },
      { key: 'measuring-instruments', en: 'Measuring Instruments', ar: 'أجهزة القياس', es: 'Instrumentos de Medición' },
      { key: 'calibration-equipment', en: 'Calibration Equipment', ar: 'معدات المعايرة', es: 'Equipos de Calibración' },
    ] },
  { key: 'safety-ppe', en: 'Safety & PPE', ar: 'السلامة ومعدات الحماية الشخصية', es: 'Seguridad y EPP',
    items: [
      { key: 'ppe', en: 'PPE', ar: 'معدات الحماية الشخصية', es: 'EPP' },
      { key: 'safety-shoes', en: 'Safety Shoes', ar: 'أحذية السلامة', es: 'Calzado de Seguridad' },
      { key: 'safety-helmets', en: 'Safety Helmets', ar: 'خوذ السلامة', es: 'Cascos de Seguridad' },
      { key: 'safety-gloves', en: 'Safety Gloves', ar: 'قفازات السلامة', es: 'Guantes de Seguridad' },
      { key: 'safety-goggles', en: 'Safety Goggles', ar: 'نظارات السلامة', es: 'Gafas de Seguridad' },
      { key: 'respiratory-protection', en: 'Respiratory Protection', ar: 'حماية الجهاز التنفسي', es: 'Protección Respiratoria' },
      { key: 'safety-equipment', en: 'Safety Equipment', ar: 'معدات السلامة', es: 'Equipos de Seguridad' },
      { key: 'fire-emergency-equipment', en: 'Fire & Emergency Equipment', ar: 'معدات الحريق والطوارئ', es: 'Equipos contra Incendios y Emergencias' },
    ] },
  { key: 'it-office', en: 'IT & Office Supplies', ar: 'تقنية المعلومات والمستلزمات المكتبية', es: 'TI y Suministros de Oficina',
    items: [
      { key: 'computers-accessories', en: 'Computers & Accessories', ar: 'الحواسيب وملحقاتها', es: 'Computadoras y Accesorios' },
      { key: 'printers-consumables', en: 'Printers & Consumables', ar: 'الطابعات ومستهلكاتها', es: 'Impresoras y Consumibles' },
      { key: 'networking-equipment', en: 'Networking Equipment', ar: 'معدات الشبكات', es: 'Equipos de Red' },
      { key: 'software-it-services', en: 'Software & IT Services', ar: 'البرمجيات وخدمات تقنية المعلومات', es: 'Software y Servicios de TI' },
      { key: 'office-supplies', en: 'Office Supplies', ar: 'المستلزمات المكتبية', es: 'Suministros de Oficina' },
      { key: 'stationery', en: 'Stationery', ar: 'القرطاسية', es: 'Papelería' },
      { key: 'office-furniture', en: 'Office Furniture', ar: 'الأثاث المكتبي', es: 'Mobiliario de Oficina' },
    ] },
  { key: 'vehicles-transport', en: 'Vehicles & Transportation', ar: 'المركبات والنقل', es: 'Vehículos y Transporte',
    items: [
      { key: 'vehicles', en: 'Vehicles', ar: 'المركبات', es: 'Vehículos' },
      { key: 'vehicle-spare-parts', en: 'Vehicle Spare Parts', ar: 'قطع غيار المركبات', es: 'Repuestos de Vehículos' },
      { key: 'tires', en: 'Tires', ar: 'الإطارات', es: 'Neumáticos' },
      { key: 'batteries', en: 'Batteries', ar: 'البطاريات', es: 'Baterías' },
      { key: 'vehicle-maintenance', en: 'Vehicle Maintenance', ar: 'صيانة المركبات', es: 'Mantenimiento de Vehículos' },
      { key: 'vehicle-accessories', en: 'Vehicle Accessories', ar: 'ملحقات المركبات', es: 'Accesorios de Vehículos' },
      { key: 'transportation-vehicles', en: 'Transportation Vehicles', ar: 'مركبات النقل', es: 'Vehículos de Transporte' },
    ] },
  { key: 'logistics-freight', en: 'Logistics & Freight Services', ar: 'الخدمات اللوجستية والشحن', es: 'Servicios Logísticos y de Carga',
    items: [
      { key: 'local-transportation', en: 'Local Transportation', ar: 'النقل المحلي', es: 'Transporte Local' },
      { key: 'international-freight', en: 'International Freight', ar: 'الشحن الدولي', es: 'Transporte Internacional' },
      { key: 'sea-freight', en: 'Sea Freight', ar: 'الشحن البحري', es: 'Transporte Marítimo' },
      { key: 'road-transportation', en: 'Road Transportation', ar: 'النقل البري', es: 'Transporte Terrestre' },
      { key: 'customs-clearance', en: 'Customs Clearance', ar: 'التخليص الجمركي', es: 'Despacho Aduanero' },
      { key: 'warehousing', en: 'Warehousing', ar: 'التخزين', es: 'Almacenamiento' },
      { key: 'logistics-services', en: 'Logistics Services', ar: 'الخدمات اللوجستية', es: 'Servicios Logísticos' },
    ] },
  { key: 'maintenance-services', en: 'Maintenance & Technical Services', ar: 'خدمات الصيانة والخدمات الفنية', es: 'Servicios de Mantenimiento y Técnicos',
    items: [
      { key: 'mechanical-maintenance', en: 'Mechanical Maintenance', ar: 'الصيانة الميكانيكية', es: 'Mantenimiento Mecánico' },
      { key: 'electrical-maintenance', en: 'Electrical Maintenance', ar: 'الصيانة الكهربائية', es: 'Mantenimiento Eléctrico' },
      { key: 'equipment-maintenance', en: 'Equipment Maintenance', ar: 'صيانة المعدات', es: 'Mantenimiento de Equipos' },
      { key: 'facility-maintenance', en: 'Facility Maintenance', ar: 'صيانة المرافق', es: 'Mantenimiento de Instalaciones' },
      { key: 'technical-support', en: 'Technical Support', ar: 'الدعم الفني', es: 'Soporte Técnico' },
      { key: 'installation-services', en: 'Installation Services', ar: 'خدمات التركيب', es: 'Servicios de Instalación' },
      { key: 'inspection-testing', en: 'Inspection & Testing', ar: 'الفحص والاختبار', es: 'Inspección y Ensayos' },
      { key: 'calibration-services', en: 'Calibration Services', ar: 'خدمات المعايرة', es: 'Servicios de Calibración' },
    ] },
  { key: 'construction-services', en: 'Construction & Contracting Services', ar: 'خدمات الإنشاء والمقاولات', es: 'Servicios de Construcción y Contratación',
    items: [
      { key: 'civil-works', en: 'Civil Works', ar: 'الأعمال المدنية', es: 'Obras Civiles' },
      { key: 'construction-works', en: 'Construction Works', ar: 'أعمال الإنشاء', es: 'Obras de Construcción' },
      { key: 'mep-works', en: 'MEP Works', ar: 'الأعمال الكهروميكانيكية (MEP)', es: 'Obras MEP' },
      { key: 'industrial-works', en: 'Industrial Works', ar: 'الأعمال الصناعية', es: 'Obras Industriales' },
      { key: 'installation-works', en: 'Installation Works', ar: 'أعمال التركيب', es: 'Obras de Instalación' },
      { key: 'contracting-services', en: 'Contracting Services', ar: 'خدمات المقاولات', es: 'Servicios de Contratación' },
      { key: 'project-services', en: 'Project Services', ar: 'خدمات المشاريع', es: 'Servicios de Proyectos' },
    ] },
  { key: 'general-supplies', en: 'General Supplies', ar: 'المستلزمات العامة', es: 'Suministros Generales',
    items: [
      { key: 'cleaning-materials', en: 'Cleaning Materials', ar: 'مواد التنظيف', es: 'Materiales de Limpieza' },
      { key: 'facility-supplies', en: 'Facility Supplies', ar: 'مستلزمات المرافق', es: 'Suministros para Instalaciones' },
      { key: 'general-consumables', en: 'General Consumables', ar: 'المستهلكات العامة', es: 'Consumibles Generales' },
      { key: 'uniforms', en: 'Uniforms', ar: 'الزي الموحد', es: 'Uniformes' },
      { key: 'furniture', en: 'Furniture', ar: 'الأثاث', es: 'Mobiliario' },
      { key: 'catering-supplies', en: 'Catering Supplies', ar: 'مستلزمات الضيافة', es: 'Suministros de Catering' },
      { key: 'general-tools', en: 'General Tools', ar: 'الأدوات العامة', es: 'Herramientas Generales' },
      { key: 'other-general-supplies', en: 'Other General Supplies', ar: 'مستلزمات عامة أخرى', es: 'Otros Suministros Generales' },
    ] },
  { key: 'other', en: 'Other', ar: 'أخرى', es: 'Otros',
    items: [
      { key: 'other-products', en: 'Other Products', ar: 'منتجات أخرى', es: 'Otros Productos' },
      { key: 'other-materials', en: 'Other Materials', ar: 'مواد أخرى', es: 'Otros Materiales' },
      { key: 'other-services', en: 'Other Services', ar: 'خدمات أخرى', es: 'Otros Servicios' },
    ] },
];
...
const PROCUREMENT = [
  ...
  { key: 'fillers', icon: 'layers',
    picks: ['raw-materials', 'raw-materials/calcium-carbonate', 'raw-materials/silica-silica-flour'],
