...
const CATEGORIES = {
  'raw-materials': {
    ...
    items: {
      ...
      'resins': 'Resins',
      'epoxy-raw-materials': 'Epoxy Raw Materials',
      'polyurea-raw-materials': 'Polyurea Raw Materials',
      'acrylic-polymer-emulsions': 'Acrylic / Polymer Emulsions',
      'catalysts-additives': 'Catalysts & Additives',
      'plasticizers': 'Plasticizers',
      'solvents': 'Solvents',
      'bitumen-bituminous-materials': 'Bitumen & Bituminous Materials',
      'sbs-app': 'SBS / APP',
      'calcium-carbonate': 'Calcium Carbonate',
      'silica-silica-flour': 'Silica / Silica Flour',
  ...
  'production-consumables': {
    label: 'Production Materials & Consumables',
    items: {
      'production-consumables': 'Production Consumables',
      'additives': 'Additives',
      'filters': 'Filters',
      'mixing-consumables': 'Mixing Consumables',
      'spray-equipment-consumables': 'Spray Equipment Consumables',
      'production-tools': 'Production Tools',
      'other-production-consumables': 'Other Production Consumables',
    },
  },
  'insulation': {
    ...
    items: {
      ...
      'xps': 'XPS',
      'eps': 'EPS',
      'thermal-insulation-boards': 'Thermal Insulation Boards',
  ...
  'flooring': {
    ...
    items: {
      ...
      'decorative-flooring': 'Decorative Flooring',
      'flooring-aggregates': 'Flooring Aggregates',
      'flooring-additives': 'Flooring Additives',
  ...
  'protective-coatings': {
    ...
    items: {
      'anti-corrosion-coatings': 'Anti-Corrosion Coatings',
      'chemical-resistant-coatings': 'Chemical Resistant Coatings',
      'uv-resistant-coatings': 'UV Resistant Coatings',
      'protective-coatings': 'Protective Coatings',
      'industrial-coatings': 'Industrial Coatings',
      'coating-additives': 'Coating Additives',
    },
  },
  'construction-chemicals': {
    label: 'Construction Chemicals & Concrete Repair',
    items: {
      'construction-chemicals': 'Construction Chemicals',
      'repair-mortars': 'Repair Mortars',
      'grouts': 'Grouts',
      'concrete-repair-materials': 'Concrete Repair Materials',
      'concrete-additives': 'Concrete Additives',
      'surface-preparation-materials': 'Surface Preparation Materials',
      'anchoring-materials': 'Anchoring Materials',
      'concrete-protection-materials': 'Concrete Protection Materials',
    },
  },
  'sealants-adhesives': {
    label: 'Sealants & Adhesives',
    items: {
      'construction-sealants': 'Construction Sealants',
      'joint-sealants': 'Joint Sealants',
      'construction-adhesives': 'Construction Adhesives',
      'structural-adhesives': 'Structural Adhesives',
      'joint-fillers': 'Joint Fillers',
  ...
  'spare-parts': {
    ...
    items: {
      'mechanical-spare-parts': 'Mechanical Spare Parts',
      ...
      'maintenance-consumables': 'Maintenance Consumables',
      'tools': 'Tools',
    },
  },
  'electrical': {
    label: 'Electrical Materials & Equipment',
    items: {
      'cables': 'Cables',
      'switches': 'Switches',
  ...
  'mechanical': {
    label: 'Mechanical Materials & Equipment',
    items: {
  ...
  'laboratory': {
    label: 'Laboratory Equipment & Chemicals',
    items: {
  ...
  'safety-ppe': {
    ...
    items: {
      ...
      'fire-emergency-equipment': 'Fire & Emergency Equipment',
    },
  },
  'it-office': {
    label: 'IT & Office Supplies',
    items: {
      'computers-accessories': 'Computers & Accessories',
      'printers-consumables': 'Printers & Consumables',
  ...
  'maintenance-services': {
    label: 'Maintenance & Technical Services',
    items: {
  ...
  'construction-services': {
    label: 'Construction & Contracting Services',
    items: {
      'civil-works': 'Civil Works',
      'construction-works': 'Construction Works',
      'mep-works': 'MEP Works',
      'industrial-works': 'Industrial Works',
  ...
  'general-supplies': {
    ...
    items: {
      ...
      'facility-supplies': 'Facility Supplies',
      'general-consumables': 'General Consumables',
      'uniforms': 'Uniforms',
      'furniture': 'Furniture',
      'catering-supplies': 'Catering Supplies',
      'general-tools': 'General Tools',
      'other-general-supplies': 'Other General Supplies',
    },
  },
  'other': {
    label: 'Other',
